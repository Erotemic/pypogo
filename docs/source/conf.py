...
Notes:
    ...
    cd ~/code/pypogo/docs
    sphinx-apidoc -f -o ~/code/pypogo/docs/source ~/code/pypogo/pypogo --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/pypogo/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/pypogo/versions/
"""
#
...
# html_logo = '.static/pypogo.svg'
# html_favicon = '.static/pypogo.ico'
...
latex_documents = [
    (master_doc, 'pypogo.tex', 'pypogo Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'pypogo', 'pypogo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pypogo', 'pypogo Documentation',
     author, 'pypogo', 'One line description of project.',
     'Miscellaneous'),
]
